...
const AccordionSectionAction = (props) => {
  const {
    children,
    heading,
    expanded,
    ...
    <div className={accordionSectionClassNames}>
      ...
      >
        <h2 className="govuk-accordion__section-heading govuk-!-font-size-27">
          ...
          &nbsp;
          &nbsp;
          <Tag modifier="govuk-left govuk-tag--active">action</Tag>
          {
            locked
              ? (
...
export default AccordionSectionAction;

AccordionSectionAction.propTypes = {
...
AccordionSectionAction.defaultProps = {
  children: null,
  onClick: '',
};
